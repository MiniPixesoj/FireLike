 ...
 */
public final class TopNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public static <V extends View> TopNavigationBehavior<V> from(@NonNull V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof TopNavigationBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomNavigationBehavior");
        }
        return (TopNavigationBehavior<V>) behavior;
    }
